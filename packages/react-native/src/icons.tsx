...
export const ClockIcon = ({ size, color = "#000" }: Props) => (
  <S size={size}><Circle cx={12} cy={12} r={9} {...stroke(color)} /><Path d="M12 7v5l3 2" {...stroke(color)} /></S>
);
export const PinIcon = ({ size, color = "#000" }: Props) => (
